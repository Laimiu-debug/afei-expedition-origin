this.afei_cancel <- this.inherit("scripts/skills/skill", {
 ...
 function use(tile,free=false) {local A=::AfeiExpedition,a=this.getContainer().getActor();A.cancelSelections(a);a.setDirty(true);return true;}
});